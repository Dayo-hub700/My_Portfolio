...
const skillInfo = {
  ...
  JavaScript:
    "JavaScript is a programming language that enables interactive web pages, allowing complex features and dynamic content.",
  "Content-Creation": "Creating and sharing original videos, audio, or images to inform, inspire, or entertain others."
};
